...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h3 mb-0 text-gray-800">COMPPTE VERSEMENT -> INDEX</h1>
	</div>
	<div class="row">
		<!-- column -->
			...
			<div class="card shadow mb-4">
				<div
					...
					<h5 class="m-0 font-weight-bold text-primary">Liste des
						comptes de versement</h5>
						<a href="${pageContext.request.contextPath}/compte-versement/add/"
									...
									<td>
										<div class="hidden-sm btn-group">
											<a class="btn btn-xs btn-info" title="Modifier"
												...
												href="${pageContext.request.contextPath}/compte-versement/edit/${compte.id}"><span>
