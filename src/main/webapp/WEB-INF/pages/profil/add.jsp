...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h3 mb-0 text-gray-800">PROFINOUVEAU  </h1>
	</div>
	<div class="row">
		...
		<div class="col-xl-12 col-lg-7">
			<div class="card shadow mb-4">
				...
				<div
					...
					<h5 class="m-0 font-weight-bold text-primary">Ajouter un Profile</h5>
				</div>
				<!-- Card Body -->
				<div class="card-body table-responsive">
					<form:form action="${pageContext.request.contextPath}/profile/add" method="post"
